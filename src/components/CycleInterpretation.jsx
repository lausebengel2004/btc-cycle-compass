export function CycleInterpretation() {
  return (
    <section className="cycle-interpretation" aria-label="Interpretation der Ansicht">
      ...
      <p>
        ...
        beschreiben Ereignisse im Netzwerkverlauf, aber keine zukünftige
        Kursentwicklung.
      </p>
      <p>
        Aus dieser Darstellung folgt keine Prognose und keine Anlageempfehlung.
      </p>
    </section>
  )
}
